...
| CSS class      | Tailwind class     | Description
| -------------  |------------------- | --------------
| `.ui-hidden`   | `[&.ui-hidden]`    | Added to all `TabPanel`s except the one that is active.
| `.ui-disabled` | `[&.ui-disabled]`  | Added to the selected `Tab`.
| `.ui-hidden`   | `[&.ui-hidden]`    | Added to disabled `Tab`s.
